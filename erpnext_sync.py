# =====================================================
# 🔒 erpnext_sync.py – FINAL LOCKED + AUTO FIX + MACHINE SYNC
# ERPNext Production Integration (Safe, Stable, Production Ready)
# =====================================================
...
def auto_assign_work_orders() -> None:
    ...
    try:
        ...
        for wo in work_orders:
            ...
            # 🔥 IMPORTANT FIX → Update ERP with assigned machine ID
            update_work_order_fields(wo_name, {
                "custom_machine_id": selected_machine.id
            })
